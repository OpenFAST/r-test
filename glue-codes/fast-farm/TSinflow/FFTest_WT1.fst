...
---------------------- INPUT FILES ---------------------------------------------
"5MW_Baseline/NRELOffshrBsline5MW_Onshore_ElastoDyn_8mps.dat"   EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"5MW_Baseline/NRELOffshrBsline5MW_Onshore_ServoDyn_WT1.dat"           ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
