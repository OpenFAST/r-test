...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          0   CompAero        - Compute aerodynamic loads (switch) {0=None; 2=AeroDyn v15}
...
"AOC_YFriction_Stiffness_AD15.ipt"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
