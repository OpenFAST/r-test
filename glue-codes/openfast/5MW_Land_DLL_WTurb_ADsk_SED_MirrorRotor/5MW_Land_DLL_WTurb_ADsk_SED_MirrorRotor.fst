...
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
          ...
          T   MirrorRotor     - Flag to reverse rotor rotation direction [1 to NRotors] {F=Normal, T=Mirror}
...
---------------------- INPUT FILES ---------------------------------------------
"../5MW_Land_DLL_WTurb_ADsk_SED/NREL_5MW_Simplified-ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn/Simplified-ElastoDyn input parameters (quoted string)
...
"../5MW_Baseline/NRELOffshrBsline5MW_InflowWind_12mps_MirrorY.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../5MW_Land_DLL_WTurb_ADsk_SED/NRELOffshrBsline5MW_Onshore_AeroDisk.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../5MW_Land_DLL_WTurb_ADsk_SED/NRELOffshrBsline5MW_Onshore_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
