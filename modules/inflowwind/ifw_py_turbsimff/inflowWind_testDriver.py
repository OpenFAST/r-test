...
outfile = DebugOut(velocities_file)
...
for i in range( 0, len(time)):
    ...
    outfile.write(time[i],positions,velocities)
...
OutFile=WriteOutChans(output_file,ifwlib.output_channel_names,ifwlib.output_channel_units)
