...
"OpenFAST_BAR_00_AeroDyn15_FVW.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
...
"ES12.4E2"             OutFmt      - Format used for text tabular output, excluding the time channel.  Resulting field should be 10 characters. (quoted string)
---------------------- LINEARIZATION -------------------------------------------
